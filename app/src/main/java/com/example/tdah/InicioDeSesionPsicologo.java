...
public class InicioDeSesionPsicologo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inicio_de_sesion_psicologo);
        ...
        btn_iniciar_sesion.setOnClickListener(v -> {
            if(TextUtils.isEmpty(txt_correo.getText())||TextUtils.isEmpty(txt_contrasena.getText())){
                Toast.makeText(InicioDeSesionPsicologo.this, "No se pudo iniciar sesión" , Toast.LENGTH_SHORT).show();
            }else {
                if (boolean_correo && boolean_contrasena) {
                    Toast.makeText(InicioDeSesionPsicologo.this, "Datos incorrectos", Toast.LENGTH_LONG).show();
                } else {
        ...
        mAuth.signInWithEmailAndPassword(correo, contrasena)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(InicioDeSesionPsicologo.this, "Error de autentificación",
    ...
    public void ir_a_registro_psicologo(View view) {

        startActivity(new Intent(this, RegistroPsicologo.class));
    }
